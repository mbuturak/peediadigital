                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <form class="form" action="<?php echo base_url('DashboardAbout/update') ?>" method="POST" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="text-center col-12">
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <h5 class="card-title">Görsel</h5>
                                                                    <img class="img-rounded" width="15%" src="<?php echo ($item[0]->image != null) ? base_url('assets/uploads/about/' . $item[0]->image) : base_url('assets/uploads/no-photo.png') ?>" alt="<?php echo $item[0]->title ?>">
                                                                </div>
                                                                <div class="card-content">
                                                                    <div class="card-body">
